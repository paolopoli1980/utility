 ...
 #    pygame.display.update()
    ...
    for k in range(len(shotherodirection)):
        if shotherodirection[k]=='r':
            shotherocoordinates[k][0]+=10*1
 
        if shotherodirection[k]=='l':
            shotherocoordinates[k][0]-=10*1
        if shotherodirection[k]=='up':
            shotherocoordinates[k][1]-=10*1
...
#                   if el.lifeenemy[cont2]>0:
                   ...
                   for t in range(5):
                       if el.shotting[cont2][t][0]>0 and el.shotting[cont2][t][0]<width and el.shotting[cont2][t][1]>0 and el.shotting[cont2][t][1]<height:
                             ...
                             el.shotting[cont2][t][0]+=el.typeshotting[cont2][t][0]*3
                             el.shotting[cont2][t][1]+=el.typeshotting[cont2][t][1]*3
     ...
     #                           el.cordobj[cont3][0]-=1
                       ...
                       if el.shotting[cont2][t][0]>x and el.shotting[cont2][t][0]<x+wx and el.shotting[cont2][t][1]>y and el.shotting[cont2][t][1]<y+wy:
                           exit()
                   #cont2+=1
