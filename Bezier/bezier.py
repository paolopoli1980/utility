...
#pygame.draw.circle(surfaceRender,RED,(100,100),20)
#surfaceRender.convert()
...
while not done:
 ...
 #                          listobj[p-1].curvepointx=[]
 #                          listobj[p-1].curvepointy=[]
  ...
  #                 print listobj[p].index2
   ...
   #                  listobj[cont].index2+=1
   #              listobj[cont].drawpoint(x,y)
